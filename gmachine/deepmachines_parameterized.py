        ...
        while not DarmGCActions.stop == int(current_state):
            if last_added_node_idx < 0 or DarmGCActions.add_node == int(current_state):
                ...
                for n in range(node_num):
                    ...
                    self._g.add_edge(last_added_node_idx, graph_rand_node)
                ...
                self._g.add_edge(n2, n3)
                self._initialize_edge_repr(n2, n3)
                self._g.add_edge(n1, n3)
                ...
                for i in range(edge_num):
                    ...
                    if not self._g.has_edge_between(tri_rand_node, graph_rand_node):
                        self._g.add_edge(tri_rand_node, graph_rand_node)
